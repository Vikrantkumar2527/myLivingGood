...
function Orders() {
  ...
  return (
    <div className="mx-1 sm:mx-12  my-6">
      <Title1 text1={"MY"} text2={"ORDERS"} />
      {orders.reverse().map((ele, idx) => {
        return (
          <div
            className="border border-black h-[270px] sm:h-[180px] p-2 my-2 flex justify-between"
            key={idx}
          >
            <div className="flex flex-col md:flex-row ">
              <img
                className="w-32 h-16 sm:h-32 mr-3"
                src={ele.image[0]}
                alt=""
              />
              <div className="flex flex-col justify-evenly h-40">
                ...
                <p>
                  ...
                  <span className="text-gray-500">
                    {new Date(Number(ele.date)).toString().split("GMT")[0]}
                  </span>
                </p>
            ...
            <div className="flex flex-col sm:flex-row  w-[40%] justify-center gap-6 sm:gap-0  sm:justify-between p-2">
              ...
              <div className="hidden sm:flex justify-center items-center">
                <button
                  onClick={() => fetchOrder()}
                  className="border text-[10px] p-2 rounded hover:bg-black hover:text-white"
                >
                  Trace Order
                </button>
              </div>
